...
// TSP 
std::vector <double> path[NUM_CELL];
//
...
{
  std::string fileNameWithNoExtension = "utility/global_"+std::to_string(TOTAL_SITE)+"_"+std::to_string((int)MAX_RESOURCE_PER_UAV);
  std::string graphicsFileName        = "global_"+std::to_string(TOTAL_SITE)+"_"+std::to_string((int)MAX_RESOURCE_PER_UAV) + ".png";
...
{
  std::string fileNameWithNoExtension = "numUAV/global_"+std::to_string(TOTAL_SITE)+"_"+std::to_string((int)MAX_RESOURCE_PER_UAV);
  std::string graphicsFileName        = "global_"+std::to_string(TOTAL_SITE)+"_"+std::to_string((int)MAX_RESOURCE_PER_UAV) + ".png";
  std::string plotFileName            = fileNameWithNoExtension + ".plt";
  //std::string plotTitle               = "2-D Plot";
...
void CreatePathPlot ()
{
  std::string fileNameWithNoExtension = "path/global_"+std::to_string(TOTAL_SITE)+"_"+std::to_string((int)MAX_RESOURCE_PER_UAV);
...
void GlobalTSP(int cellId) // Read solution from file
{
  std::vector<double> p;
  std::string filename = "output_global_tsp/output_"+std::to_string(cellId)+"_"+std::to_string(TOTAL_SITE)+"_"+std::to_string((int)MAX_RESOURCE_PER_UAV)+"_"+std::to_string(numScenario)+".txt";
  ReadData(filename, p);  
  path[cellId].clear();
  path[cellId] = p;
  return ;
